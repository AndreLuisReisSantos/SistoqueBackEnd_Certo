...
const inputsInfo = {
  ...
  EnumUnidadeMedidaFilter: ["equals", "in", "notIn", "not"],
  ...
  EnumUnidadeMedidaWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ...
  EnumUnidadeMedidaFieldUpdateOperationsInput: ["set"],
  CategoriaProdutoUpdateOneRequiredWithoutProdutoInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  NestedEnumUnidadeMedidaFilter: ["equals", "in", "notIn", "not"],
  NestedEnumUnidadeMedidaWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
